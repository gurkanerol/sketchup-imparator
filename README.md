...
## Version 0.28 Modernization (2026)
...
## Technical Credits
- **gurkanerol**: 2026 Modernization (N-gons, UV Scaling, Mac Build Automation)
- **Martijn Berger**: Original `pyslapi` creator and maintainer
...
3. The distributable addon will be generated in:
   `dist/sketchup_importer_universal.zip`
